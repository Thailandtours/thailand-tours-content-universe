...
Brug denne skabelon til en hoteltekst, når kilden skal omskrives til den aftalte tone.

```markdown
---
{BEVAR FRONTMATTER UÆNDRET}
---
...
**{Værelser, villaer eller suiter med konkret forskel}**
{Beskriv værelsestyper uden at opfinde nye facts. Forklar hvem der skal vælge hvad.}

**{Pool, strand eller hotelrytme}**
{Beskriv de vigtigste faciliteter som oplevelse og funktion, ikke som liste. Bevar alle vigtige features.}

**{Mad, morgenmad og aftener}**
